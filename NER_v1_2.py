# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 18:25:11 2019
...
## Read Input data files for mapping purpose
df = pd.read_csv("C:/Users/mayur.v/Desktop/BHGE/Issue_Trending/Issue_Trending/EBS_PGT.csv",delimiter = ',',encoding = 'latin1')

df1 = pd.read_csv("C:/Users/mayur.v/Desktop/BHGE/Issue_Trending/Issue_Trending/Instrument_List.csv",delimiter = ',',encoding = 'latin1')

df2 = pd.read_csv("C:/Users/mayur.v/Desktop/BHGE/Issue_Trending/Issue_Trending/Equipment_List.csv",delimiter = ',',encoding = 'latin1')
...
df3 = pd.read_csv("C:/Users/mayur.v/Desktop/BHGE/Issue_Trending/Issue_Trending/EBS_PGT.csv",delimiter = ',',encoding = 'latin1')
...
df3['PMHD_TA005_GRP_T_DES'] = df3['PMHD_TA005_GRP_T_DES'].apply(lambda x:pre_process(x))

        
compo_list = []
for i in range(0,len(df3['PMHD_TA005_GRP_T_DES'])):
    #print(i)
    compo_list.append(df3['PMHD_TA005_GRP_T_DES'][i])
    
compo_list = [x.lower() for x in compo_list]

df_fin.head()
mapped_entities = []       
for i in range(0,len(df_fin['Named_Entity'][1:5])):
    #print(i)
    mapped_entities.append(set(process.extract(df_fin['Named_Entity'][i], compo_list, limit=10)))
...
df_fin.to_csv('C:/Users/mayur.v/Desktop/BHGE/Named_Entity_Model_v1.33.csv')


sent = 'air sand'.split()
list(everygrams(sent))

sent = word_tokenize("air sand")
# Extracts 2-grams, 3-grams and 4-grams
sent_2to4grams = everygrams(sent, 1, 2)
